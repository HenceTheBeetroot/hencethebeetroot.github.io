...
export default class ParticleSystemObject extends SceneObject {
  ...
  async createParticleGeometry() {
    ...
    // TODONE 1 - create ping-pong buffers to store and update the particles in GPU
  ...
  async createShaders() {
    ...
    // TODONE 2 - Create the bind group layout for using the ping-pong buffers in the GPU
