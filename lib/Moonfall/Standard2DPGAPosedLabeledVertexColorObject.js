/* 
 * >>>>>> !README! <<<<<<
 * This version is identical to the one found in the DSViz library, aside from adding an optional "label" parameter.
 * It is kept separate so that I can merge files with updated versions freely, without worring about this modification being lost.
 * However, all rights go to the original author, SingChun LEE.
 */
...
export default class Standard2DPGAPosedVertexColorObject extends SceneObject {
  constructor(device, canvasFormat, vertices, pose, label = "") {
